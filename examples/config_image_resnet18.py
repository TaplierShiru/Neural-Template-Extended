...
## config debugger
debug_base_folder = r'/path/to/svr_resnet18'
...
img_arch_type = 'resnet18' # resnet18 resnet34 resnet50
img_final_act_func = torch.sigmoid # torch.sigmoid torch.tanh None
type_block = 'ResNetBlockSM' # ResNetBlockSM ResNetBlockSMBN # affect only ResNeT18 and ResNet34
img_linear_use_bn = False # True False
