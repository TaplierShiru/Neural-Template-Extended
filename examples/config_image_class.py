...
## config debugger
debug_base_folder = r'/path/to/train_neural_template'
...
use_testing = False
testing_interval = 1
auto_encoder_config_path = r'/path/to/train_neural_template/2023-07-24_13-55-13_IM-Net-Training-experiment-home-AutoEncoder-3DCNN-Flow/config.py'
auto_encoder_resume_path = r'/path/to/train_neural_template/2023-07-24_13-55-13_IM-Net-Training-experiment-home-AutoEncoder-3DCNN-Flow/model_epoch_2_310.pth'
